...
// import { app } from "./server.mjs"; // Adjust the import path as necessary
...
//   // test("should read emails and log them", async () => {
...
//   // });
//   // test.skip("should send an email and verify its content when read", async () => {
//   //   const mockConnect = mocked(connect);
//   //   const mockSimpleParser = mocked(simpleParser);
